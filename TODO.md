...
- [ ] **D6 + D7** IBKR heartbeat + multi-broker union for positions/orders/journal. Two-phase plan in [`docs/superpowers/plans/2026-04-14-multi-broker-positions.md`](docs/superpowers/plans/2026-04-14-multi-broker-positions.md) (PR 1 = D6 heartbeat, PR 2 = D7 aggregation). Spec: [`docs/superpowers/specs/2026-04-14-multi-broker-positions-design.md`](docs/superpowers/specs/2026-04-14-multi-broker-positions-design.md).
