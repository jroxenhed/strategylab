# TODO.md before the 2026-09-12 rewrite (frozen copy)

Frozen on 2026-09-12 before the reader-first rewrite. Grep here by item code for the old long form.
...
- [ ] <a id="f423"></a> **F423** F199 deadline middleware observability — sustained 504s leave sync route work running in the threadpool (documented limitation, review R-06): no starvation monitoring or backpressure. Add a gauge/log when active-deadline-exceeded count crosses a threshold, and consider cooperative checkpoints in run_backtest. [arch]
